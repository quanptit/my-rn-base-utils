...
import com.generalUtils.commonUtils.CommonUtils;
import com.generalUtils.DialogUtils;
...
public class RNSpeedToText extends ReactContextBaseJavaModule implements RecognitionListener {
    ...
    public void onReadyForSpeech(Bundle params) {
        ...
        Utils.sendEvent(getReactApplicationContext(), "StartSpeakComplete", null);
    }
    ...
    public void onError(int error) {
        ...
        Utils.sendEvent(getReactApplicationContext(), "ErrorSpeak", mError);
    }
    ...
    private void sendResultData(String bestResult, String error) {
        ...
        Utils.sendEvent(getReactApplicationContext(), "SeakResult", writableMap);
    }
