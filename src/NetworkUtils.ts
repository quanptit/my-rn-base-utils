...
export default class NetworkUtils {
    ...
    static saveCacheFile(url: string, response: string, callback?: (isSuccess: boolean) => void) {
     ...
     * */
    static async excuteHttpTypeFormData(method: string, url: string, body: any[]): Promise<string> {
        /*
